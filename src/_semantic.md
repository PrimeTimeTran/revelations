...
1. List pkgs/deps/symbols
   User types "use foo." - How do we answer this "best"? - crate.pkgs... - self.modules... - self.scope...
   A "stack pop" works but might become inefficient.
   A "stack pop" works but might become inefficient.

2. Gather metrics/telemetry:
   - How many files, deps, mods, identifies, files?

3. Build graph registry:
4. "Jump to caller":
5. Add IRB like interpreter
6. Add runtime "debugger"
...
The mistake to avoid is making the semantic workspace answer _every possible question directly_.
